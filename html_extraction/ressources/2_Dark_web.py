...
Html = lxml.html.parse("/Users/admin/Documents/MA-1.2/ACO/TPs/IVI/2_http___cc365rfnwxcmeizmlxo2unibbodwqykjrxvaawjj6ofs5clondovalid.onion_clientCode.html").getroot()
...
attribute_dict_2_Darkweb = {'class': unique_class_results, 'id': unique_id_results}

with open('../dictionnaire/attribute_dict_2_Darkweb.json', 'w') as json_file:
    json.dump(attribute_dict_2_Darkweb, json_file)

print("Attributes Dictionary:")
print(attribute_dict_2_Darkweb)
print("Attributes Dictionary has been saved to attribute_dict_2_Darkweb.json")
