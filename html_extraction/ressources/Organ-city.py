...
Html = lxml.html.parse("../html_files/CodeClient_organ_city.html").getroot()
...
attribute_dict_Organ_city = {'class': unique_class_results, 'id': unique_id_results}

with open('attribute_dict_Organ_city.json', 'w') as json_file:
    json.dump(attribute_dict_Organ_city, json_file)

print("Attributes Dictionary:")
print(attribute_dict_Organ_city)
print("Attributes Dictionary has been saved to attribute_dict_Organ_city.json")
