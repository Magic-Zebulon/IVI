...
Html = lxml.html.parse("/Users/admin/Documents/MA-1.2/ACO/TPs/IVI/1_http___bmgunsszmlrt3wvghzthp45nbzftx7udgrlkderdn4vbexakhfx3m7id.onion_clientCode.html").getroot()
...
attribute_dict_1_Darkweb = {'class': unique_class_results, 'id': unique_id_results}

with open('../dictionnaire/attribute_dict_1_Darkweb.json', 'w') as json_file:
    json.dump(attribute_dict_1_Darkweb, json_file)

print("Attributes Dictionary:")
print(attribute_dict_1_Darkweb)
print("Attributes Dictionary has been saved to attribute_dict_1_Darkweb.json")
