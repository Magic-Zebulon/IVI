...
Html = lxml.html.parse("/Users/admin/Documents/MA-1.2/ACO/TPs/IVI/5_http___shoprypxphsufyldigdn34kbjbsnjnrmv2z34yc5al5lkmveqcbex2qd.onion_about-us_clientCode.html").getroot()
...
attribute_dict_5_Darkweb = {'class': unique_class_results, 'id': unique_id_results}

with open('../dictionnaire/attribute_dict_5_Darkweb.json', 'w') as json_file:
    json.dump(attribute_dict_5_Darkweb, json_file)

print("Attributes Dictionary:")
print(attribute_dict_5_Darkweb)
print("Attributes Dictionary has been saved to attribute_dict_5_Darkweb.json")
