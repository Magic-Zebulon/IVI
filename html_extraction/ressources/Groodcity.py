...
Html = lxml.html.parse("../html_files/IVI:ClearWeb:results:code_client_serveur:CodeClient_groodcity.html").getroot()
...
attribute_dict_Groodcity = {'class': unique_class_results, 'id': unique_id_results}
with open('../dictionnaire/attribute_dict_groodcity.json', 'w') as json_file:
    json.dump(attribute_dict_Groodcity, json_file)

print("Attributes Dictionary for groodcity has been saved to attribute_dict_groodcity.json")
print("Attributes Dictionary:")
print(attribute_dict_Groodcity)