...
Html = lxml.html.parse("../html_files/IVI:ClearWeb:results:code_client_serveur:CodeClient_organcity.html").getroot()
...
attribute_dict_Organcity = {'class': unique_class_results, 'id': unique_id_results}

with open('../dictionnaire/attribute_dict_Organcity.json', 'w') as json_file:
    json.dump(attribute_dict_Organcity, json_file)

print("Attributes Dictionary:")
print(attribute_dict_Organcity)
print("Attributes Dictionary has been saved to attribute_dict_Organcity.json")
