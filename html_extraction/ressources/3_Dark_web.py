...
Html = lxml.html.parse("/Users/admin/Documents/MA-1.2/ACO/TPs/IVI/3_http___rhc62vwjq25n52umfmfkm4yq7yuxwuk6bjduyvzjzhb3cyhp2q65m2qd.onion_product=human-organs-from-ua_clientCode.html").getroot()
...
attribute_dict_3_Darkweb = {'class': unique_class_results, 'id': unique_id_results}

with open('../dictionnaire/attribute_dict_3_Darkweb.json', 'w') as json_file:
    json.dump(attribute_dict_3_Darkweb, json_file)

print("Attributes Dictionary:")
print(attribute_dict_3_Darkweb)
print("Attributes Dictionary has been saved to attribute_dict_3_Darkweb.json")
