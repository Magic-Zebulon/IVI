...
def visualize_documents(topic_model,
    ...
    data_0 = pd.DataFrame(columns=['id','x','y'])
    ...
    data_0['id'] = selection.doc
    data_0['x'] = selection.x
    data_0['y'] = selection.y
    ...
    for name, topic in zip(names, unique_topics):
        if topic in topics and topic != -1:
            ...
            data_1 = pd.DataFrame(columns=['id','x','y'])
            fig.add_trace(
                go.Scattergl(
                    x=selection.x,
                    y=selection.y,
            ...
            data_1['id'] = selection.doc
            data_1['x'] = selection.x
            data_1['y'] = selection.y
            data_0 = pd.concat([data_0, data_1], ignore_index=True)
